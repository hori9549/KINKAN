...
Public Class sfrm出勤確認
    ...
    Private Sub sfrm出勤確認_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If dtbl職員.Rows.Count <> 0 Then
            lblメッセージ.Text = "おはようございます。" & vbCrLf
            lblメッセージ.Text += "【" & dtbl職員.Rows(0)("職員氏名") & "】さん" & vbCrLf
            lblメッセージ.Text += "本日もよろしくお願いします。" & vbCrLf & vbCrLf

            lblメッセージ.Text += "検温結果を選択してください。"
